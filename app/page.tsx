...
export default function Home() {
  const visionData = `<p className="bg-[url('https://i.ibb.co/RDTnNrT/animated-text-fill.png')] inline bg-repeat-y animate-BgText bg-clip-text text-transparent">We aspire to become a global leader in both brands and technologies.</p>`;
  const missionData =
