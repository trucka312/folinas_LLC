...
const OurStory = () => {
    ...
    const sliderContent = sliderData.map((item, index) => (
        <div key={index} className="flex wrap items-center -mx-[15px]">
    ...
    return (
        <div id="our-store" className="py-12">
            <Container>
                ...
                <SlickSlider content={sliderContent} slidesToScroll={1} slidesToShow={1} speed={1000} autoplaySpeed={6000} infinite dots fade={false} className='w-full' />
                <AboutUs />
            </Container>
        </div>
    )
