    ...
    <div className="my-20">
      <div className="flex flex-wrap items-center">
        <div className="w-full md:w-[50%] lg:pr-12 mb-[30px] lg:mb-0">
          <h4 className="mt-0 lg:mt-6 text-[rgb(var(--second-rgb))] text-4xl lg:text-7xl ">
            <span className="text-[rgb(var(--foreground-rgb))]">Growing</span>{" "}
            Day by Day,
          </h4>
          <h5 className="mt-0 lg:mt-6 text-[rgb(var(--second-rgb))] text-4xl lg:text-7xl">
            <span className="text-[rgb(var(--foreground-rgb))]">Advancing</span>{" "}
            Step by Step.
          </h5>
        </div>
        <div className="w-full md:w-[50%] px-[15px]">
          <div className="rounded-md overflow-hidden">
            <Image src={AboutImage} alt="About Growing" />
          </div>
        </div>
      </div>
      ...
      {aboutImageData?.map((item, index) => (
        <div key={index} className="mt-10 w-[1248px] mx-auto">
          ...
          <div
            className="mt-3 grid gap-[16px] grid-cols-[repeat(3,1fr)] grid-rows-[repeat(1,1fr)]  mx-auto items-center"
