  ...
  return (
    <header className={className}>
      ...
      <div
        ...
        id="header"
        className={`${
          isScrolledUp ? "fixed animate-fadeInDown" : "absolute"
        } top-0 left-0 right-0 z-[2] transition-all py-1 md:py-5 bg-[linear-gradient(180deg,rgb(0_0_0/77%),rgb(0_0_0/8%))] text-white`}
      >
        <Container>
